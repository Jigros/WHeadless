...
const DEFAULT_CONFIG = {
  ...
  bot_defaults: {
    ...
    cashout_temporary_retry_delay_ms: 30000,
    cashout_all_stagger_min_ms: 5000,
    cashout_all_stagger_max_ms: 20000,
    cashout_max_single_payment_amount: 20000000,
    cashout_chunk_delay_ms: 5000,
    cashout_verify_attempts: 6,
    cashout_verify_interval_ms: 5000,
    cashout_verify_min_drop_ratio: 0.8,
    cashout_balance_cache_max_age_ms: 3600000,
    cashout_reconnect_on_unconfirmed: false,
    cashout_retry_after_reconnect: false,
    cashout_reconnect_retry_delay_ms: 5000,
    balance_command: '/balance',
    balance_command_wait_ms: 5000,
    tpa_reconnect_on_no_confirmation: false,
    ...
    reconnect_pre_connect_delay_ms: 5000,
    reconnect_min_ms: 45000,
    reconnect_max_ms: 60000,
    microsoft_auth_service_retry_min_ms: 300000,
    microsoft_auth_service_retry_max_ms: 1800000,
    microsoft_auth_service_alert_cooldown_ms: 900000,
    reconnect_on_kick: true,
    ...
    spawn_home_enabled: true,
    spawn_home_wait_ms: 6500,
    spawn_home_cooldown_ms: 30000,
    farming_enabled: true,
    disconnect_home_enabled: true,
    disconnect_home_wait_ms: 6500,
    farm_refresh_enabled: true,
    farm_refresh_interval_ms: 3600000,
    farm_refresh_min_interval_ms: 3300000,
    farm_refresh_home2_wait_ms: 6000,
    farm_refresh_home1_wait_ms: 6500,
    ...
    home_recovery_repeat_cooldown_ms: 300000,
    ...
    home_recovery_ignore_no_target_farming: true,
    home_recovery_no_target_grace_ms: 120000,
