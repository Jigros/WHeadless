...
const DEFAULT_CONFIG = {
  ...
  bot_defaults: {
    ...
    cashout_temporary_retry_delay_ms: 0,
    cashout_all_stagger_min_ms: 0,
    cashout_all_stagger_max_ms: 0,
    cashout_max_single_payment_amount: 10000000,
    cashout_chunk_delay_ms: 0,
